...
public class NivelPantalla extends AppCompatImageView {
  ...
  //      trazoDibujo.setColor(Color.BLACK);
        trazoDibujo.setColor(getResources().getColor(R.color.colorSecondary, null));

        trazoDibujo.setTextSize(20);
  //      trazoDibujo.setTextAlign(Paint.Align.CENTER);
    ...
    private Bitmap iniciaFondo(){
       ...
       // lapiz.setColor(Color.RED);
        lapiz.setColor(getResources().getColor(R.color.colorPrimary, null));

        lienzo.drawCircle(radio, radio, radio, lapiz);

        lapiz.setColor(getResources().getColor(R.color.colorSecondary, null));
